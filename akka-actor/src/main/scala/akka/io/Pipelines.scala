...
class BackpressureBuffer(lowBytes: Long, highBytes: Long, maxBytes: Long)
  ...
  require(highBytes >= lowBytes, "highBytes needs to be at least as large as lowBytes")
  require(maxBytes >= highBytes, "maxBytes needs to be at least as large as highBytes")
